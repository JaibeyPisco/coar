export  default  `
        <!-- MODAL DELETE -->
          <div class="modal inmodal fade" name="modal-delete-tipo-incidencia" data-backdrop="static" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 name="delete-tipo-incidencia" class="modal-title">Eliminar Tipo Incidencia</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form name="delete-tipo-incidencia">
