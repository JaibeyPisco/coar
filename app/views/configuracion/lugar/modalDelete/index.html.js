export default /*html*/`
       <!-- MODAL DELETE -->
       <div class="modal inmodal fade" name="modal-lugar-delete" data-backdrop="static" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 name="modal-lugar-delete" class="modal-title">Eliminar lugar</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form name="lugar-delete">
