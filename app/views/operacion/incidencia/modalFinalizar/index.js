...
async function afterRender() {
    ...
    eForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            let ladda = HELPER.ladda('form[name="incidencia-finalizar"] button[type="submit"]');
            ...
            axios({
                method: 'post',
                url: BASE_API + 'operacion/incidencia/finalizar',
                data: formData
            })
                .then(async (response) => {
...
const open = (data) => {
    ...
    eView.querySelector('.modal-title').innerText = 'Finalizar incidencia';
...
const cargar = (element, callback) => {
    ...
    eView = element.querySelector(`div[name="modal-incidencia-finalizar"]`);

    eForm = eView.querySelector(`form[name="incidencia-finalizar"]`);
