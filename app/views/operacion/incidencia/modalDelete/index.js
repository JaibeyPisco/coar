...
async function afterRender() {
    ...
    eForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            let ladda = HELPER.ladda('form[name="incidencia-delete"] button[type="submit"]');
            ...
            axios({
                method: 'post',
                url: BASE_API + 'operacion/incidencia/delete',
                data: formData
            })
                .then(async (response) => {
...
const open = (data) => {
    ...
    eView.querySelector('.modal-title').innerText = 'Anular incidencia';
...
const cargar = (element, callback) => {
    ...
    eView = element.querySelector(`div[name="modal-incidencia-delete"]`);

    eForm = eView.querySelector(`form[name="incidencia-delete"]`);
