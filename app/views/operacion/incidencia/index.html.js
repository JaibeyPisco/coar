        ...
        <div class="card   radius-10 w-100">
            <div class="card-body">                                 
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Tipo Resultado de Búsqueda</label>
                            <select name="tipo_busqueda" class="form-control form-control-sm" autocomplete="off">
                                <option value="NO_FINALIZADO" selected>NO FINALIZADOS</option>
                                <option value="SEGUN_FECHA">SEGÚN FECHA</option>
                            </select>
                        </div>
                    </div>
