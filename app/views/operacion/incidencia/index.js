...
import modalDerivar from "./modalDerivar/index.js";
import modalFinalizar from "./modalFinalizar/index.js";
...
const events = () => {
    ...
    eView.querySelector('select[name="tipo_busqueda"]').addEventListener('change', function(e) {
        e.preventDefault();
        ...
        columns: [
            ...
            {title: 'ACCIÓN',
                render: function(data, type, row) {
                    ...
                    if(row.fl_estado == estados.ACTIVO && row.estado == 'REGISTRADO'){
                        html = `
                            <div class="btn-group" style="width:120px;">
                               <button type="button" class="btn btn-danger btn-sm" name="row-derivar">Derivar</button>
                               <button type="button" class="btn btn-success btn-sm" name="row-finalizar">Finalizar</button>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                                    <a class="dropdown-item" name="row-delete" href="javascript:;"><i class="fadeIn animated bx bx-trash" style="color: red; font-size: 18px;"></i> Anular</a>
                                </div>
                            </div>
                        `;
                    }
