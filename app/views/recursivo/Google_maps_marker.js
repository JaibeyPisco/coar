...
let Componente = {
        ...
        <div class="row" id="mapa_dom">
            ...
            <div class="col-md-10" >
                <div class="form-group">
                    <label>Dirección (Después de buscar la dirección debe mover el marcador)</label>
                    <input type="text" name="mapa_direccion" class="form-control" autocomplete="off" >
                </div>
            </div>    
            <div class="col-md-2" style="padding-top:20px;">
                <button type="button" name="get_direccion" class="btn btn-default"><i class="fa fa-search"></i></button>
            </div>            
            <div class="col-md-12">
                <div>Ubicación en Mapa</div>
                <div id="mapCanvas" style="height:280px; margin-bottom:10px;"></div>
            </div>
        </div>
        `;
    ...
    initital: async (input_latitud = '-12.04318', input_longitud = '-77.02824', d = 'mapa_dom') => {        
        ...
        /**** CLICK DIRECCIÓN BUSCAR */
        DOM.on('click', 'button[name="get_direccion"]', function(e) {
            e.stopImmediatePropagation();
            Componente.codeAddress();
        });
