...
-- Volcando datos para la tabla coar.ajuste_avanzado: ~1 rows (aproximadamente)
INSERT INTO `ajuste_avanzado` (`id_empresa`, `porcentaje_detraccion`, `porcentaje_igv`, `fl_sistema_logo`, `fl_sistema_change_color`, `sistema_color_bg`, `fl_pagar_factura`, `fl_tarifa_articulo`, `fl_tarifa_cliente`, `fl_tarifa_ruta`, `fl_op_os_doc_ref`, `fl_op_clave_edit_orden`, `fl_op_multiple_orden_gt`, `fl_op_emision_electronico_grt`, `fl_general_local_independiente`, `fl_op_emision_electronico_grr`, `fl_op_os_emision_grt`, `fl_facturacion_envio_manual_sunat`, `cant_decimales_venta`, `fl_fact_detraccion_automatica`, `fl_op_os_descripcion_articulo`, `fl_op_tarifa_info`, `fl_general_serie_usuario`, `porcentaje_izipay`, `termino_condicion_orden`) VALUES
	(0, 4, 18, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- Volcando estructura para tabla coar.apoderado
CREATE TABLE IF NOT EXISTS `apoderado` (
  `id` int NOT NULL AUTO_INCREMENT,
  `apellidos_nombres` varchar(255) DEFAULT NULL,
  `dni` varchar(20) DEFAULT NULL,
  `numero_telefonico` varchar(20) DEFAULT NULL,
  `grado_parentesco` varchar(50) DEFAULT NULL,
  `legalizado` char(1) DEFAULT NULL,
  `id_estudiante` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla coar.apoderado: ~0 rows (aproximadamente)

-- Volcando estructura para tabla coar.apoderado_rol_padre_madre
CREATE TABLE IF NOT EXISTS `apoderado_rol_padre_madre` (
  `id` int NOT NULL AUTO_INCREMENT,
  `parentesco_con_apoderado` varchar(50) DEFAULT NULL,
  `apellidos_nombres_apoderado` varchar(255) DEFAULT NULL,
  `dni_apoderado` varchar(20) DEFAULT NULL,
  `num_celular_apoderado` varchar(20) DEFAULT NULL,
  `tipo_familia` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla coar.apoderado_rol_padre_madre: ~2 rows (aproximadamente)
INSERT INTO `apoderado_rol_padre_madre` (`id`, `parentesco_con_apoderado`, `apellidos_nombres_apoderado`, `dni_apoderado`, `num_celular_apoderado`, `tipo_familia`) VALUES
	(1, '', '', '', '', ''),
	(4, '', '', NULL, NULL, '');
...
-- Volcando datos para la tabla coar.area: ~0 rows (aproximadamente)
INSERT INTO `area` (`id`, `nombre`, `descripcion`, `estado`, `id_usuario`, `id_empresa`, `id_encargado`) VALUES
	(1, 'AREA ADMINISTRATIVA', 'esto es genial', 1, 2, 1, 0);
...
-- Volcando datos para la tabla coar.centinela: ~98 rows (aproximadamente)
...
-- Volcando estructura para tabla coar.datos_madre
CREATE TABLE IF NOT EXISTS `datos_madre` (
  `id` int NOT NULL AUTO_INCREMENT,
  `madre_viva` char(1) DEFAULT NULL,
  `madre_con_estudiante` char(1) DEFAULT NULL,
  `apellidos_nombres_madre` varchar(255) DEFAULT NULL,
  `dni_madre` varchar(20) DEFAULT NULL,
  `grado_instruccion_madre` varchar(50) DEFAULT NULL,
  `ocupacion_actual_madre` varchar(255) DEFAULT NULL,
  `num_celular_madre` varchar(20) DEFAULT NULL,
  `correo_electronico_madre` varchar(255) DEFAULT NULL,
  `motivo_madre_no_vive_con_estudiante` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla coar.datos_madre: ~2 rows (aproximadamente)
INSERT INTO `datos_madre` (`id`, `madre_viva`, `madre_con_estudiante`, `apellidos_nombres_madre`, `dni_madre`, `grado_instruccion_madre`, `ocupacion_actual_madre`, `num_celular_madre`, `correo_electronico_madre`, `motivo_madre_no_vive_con_estudiante`) VALUES
	(1, '1', '1', '', '', '', '', '', '', NULL),
	(4, '1', '1', 'ROJAS GUERRA JANNY DE JESUS', 'OO817443', 'SUPERIOR UNIVERSITARIA', 'DOCENTE', 'NO REGISTRA', 'NO REGISTRA', NULL);

-- Volcando estructura para tabla coar.datos_padre
CREATE TABLE IF NOT EXISTS `datos_padre` (
  `id` int NOT NULL AUTO_INCREMENT,
  `padre_vivo` char(1) DEFAULT NULL,
  `padre_con_estudiante` char(1) DEFAULT NULL,
  `apellidos_nombres_padre` varchar(255) DEFAULT NULL,
  `dni_padre` varchar(20) DEFAULT NULL,
  `grado_instruccion_padre` varchar(50) DEFAULT NULL,
  `ocupacion_actual_padre` varchar(255) DEFAULT NULL,
  `correo_electronico_padre` varchar(255) DEFAULT NULL,
  `num_celular_padre` varchar(20) DEFAULT NULL,
  `motivo_padre_no_vive_con_estudiante` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla coar.datos_padre: ~2 rows (aproximadamente)
INSERT INTO `datos_padre` (`id`, `padre_vivo`, `padre_con_estudiante`, `apellidos_nombres_padre`, `dni_padre`, `grado_instruccion_padre`, `ocupacion_actual_padre`, `correo_electronico_padre`, `num_celular_padre`, `motivo_padre_no_vive_con_estudiante`) VALUES
	(1, '1', '1', '', '', '', '', '', '', ''),
	(4, '1', '1', 'ABAD PALACIO LUIS FERNANDO', '70320061', 'SECUNDARIA', 'TRANSPORTISTA', 'NO REGISTRA', 'NO REGISTRA', '');
...
INSERT INTO `empresa` (`id`, `razon_social`, `nombre_comercial`, `numero_documento`, `direccion`, `telefono`, `email`, `logo`, `id_membresia`, `origen_factura`, `formato_factura`, `tipo_proveedor_electronico`, `url_proveedor_electronico`, `id_ubigeo`, `tipo_cambio`, `porcentaje_igv`, `estado_facturacion`, `logo_factura`) VALUES
	(1, 'UGEL EL DORANO', 'COAR SM', '12344545454', 'MOYOMBAR', '787878', '4545', 'empresa-1735175379_empresa1726505217_DELOB_PNG.gif', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'empresa-1735175379_empresa1726505217_DELOB_PNG.gif');
...
INSERT INTO `estado_monitoreo` (`id`, `nombre`, `id_empresa`, `tipo`, `color_bg`, `color_text`) VALUES
	...
	(5, 'PROCESO', 1, 'INCIDENCIA', '#4a6a3e', '#fff');
...
CREATE TABLE IF NOT EXISTS `estudiante` (
  ...
  `apoderado_rol_padre_madre_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `dni_pks` (`dni`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla coar.estudiante: ~2 rows (aproximadamente)
INSERT INTO `estudiante` (`id`, `apellidos_nombres`, `obsv`, `grado`, `seccion`, `dni`, `foto`, `sexo`, `correo_electronico`, `codigo_estudiante`, `fecha_nacimiento`, `lav`, `llaves`, `pabellon`, `ala`, `cama_ropero`, `duchas`, `banos`, `urinarios`, `monitor_acompana`, `lugar_nacimiento`, `fecha_caducidad_dni`, `num_telefonico`, `religion`, `region_domicilio_actual`, `provincia_domicilio_actual`, `distrito_domicilio_actual`, `direccion_domicilio_actual`, `referencia_domicilio_actual`, `padre_id`, `madre_id`, `apoderado_rol_padre_madre_id`) VALUES
	(1, 'SERGIO ROCHA ALVAREZ', '', '3', 'C', '11', 'estudiante-1734483668_logoimg.png', 'FEMENINO', 'jaibey.pisco@tecsup.edu.pe', '*m6XzIAI&vdqh', '2024-12-25', '11', '11', '111', '11', '11', '11', '', '', '', '111', '2024-12-17', '111', '11', '11', '11', '111', 'KM 14  CARRETRA CENTRAL', '111', 1, 1, 1),
	(4, 'ABAD ROJAS ALESSIA CAROLINA', 'L-M-M', '3', 'A', '61519242', 'sin_imagen.jpg', 'FEMENINO', '61519242@coarsm.com', NULL, '2008-11-28', '7', '180', 'A1', '1', 'A1.1.1', '1', '1', NULL, 'MILAGROS SUAREZ', 'SAN MARTIN/MOYOBAMBA/MOYOBAMBA', '2025-03-13', '996546106', 'CATÓLICA', 'SAN MARTIN', 'MOYOBAMBA', 'MOYOBAMBA', 'URB VISTA ALEGRE MZ U LOTE ', 'PARQUE DE LA EPS', 4, 4, 4);
...
INSERT INTO `incidencias` (`id`, `serie`, `numero`, `id_tipo_incidencia`, `tipo`, `id_estudiante`, `descripcion`, `id_usuario`, `fecha`, `created_at`, `updated_at`, `id_lugar_incidencia`) VALUES
	(1, '2024', '00000001', 1, NULL, 1, '<p>esto es una descripcion de la incidencia</p>', 2, '2024-12-25 19:05:00', '2024-12-26 05:06:52', '2024-12-26 05:06:52', NULL),
	(2, '2024', '00000002', 1, NULL, 1, '<p>esto es un texto adiciuonal</p>', 2, '2024-12-28 00:08:00', '2024-12-26 05:09:51', '2024-12-26 05:09:51', 1),
	(3, '2024', '00000003', 1, NULL, 1, '<p>estos estudiantens son terribles</p>', 2, '2024-12-27 19:10:00', '2024-12-26 05:10:40', '2024-12-26 05:10:40', 1),
	(4, '2024', '00000003', 1, NULL, 4, '<p>estos estudiantens son terribles</p>', 2, '2024-12-27 19:10:00', '2024-12-26 05:10:40', '2024-12-26 05:10:40', 1),
	(5, '2024', '00000004', 1, NULL, 1, '<p>es genial lo que pasa&nbsp;</p>', 2, '2024-12-25 20:00:00', '2024-12-26 06:00:58', '2024-12-26 06:00:58', 1),
	(6, '2024', '00000005', 1, NULL, 1, '<p>es genial lo que pasa&nbsp;</p>', 2, '2024-12-24 20:00:00', '2024-12-26 06:01:08', '2024-12-26 06:01:08', 1),
	(7, '2024', '00000006', 1, NULL, 1, '<p>es genial lo que pasa&nbsp;</p>', 2, '2024-12-25 20:00:00', '2024-12-26 06:01:50', '2024-12-26 06:01:50', 1),
	(8, '2024', '00000007', 1, NULL, 1, '<p>esto es genial</p>', 2, '2024-12-12 20:02:00', '2024-12-26 06:03:24', '2024-12-26 06:03:24', 2),
	(9, '2024', '00000008', 1, NULL, 1, '<p>ESTOS ESTUDIANTES SON TERRIBLES</p>', 2, '2024-12-25 20:04:00', '2024-12-26 06:04:31', '2024-12-26 06:04:31', 1),
	(10, '2024', '00000008', 1, NULL, 4, '<p>ESTOS ESTUDIANTES SON TERRIBLES</p>', 2, '2024-12-25 20:04:00', '2024-12-26 06:04:31', '2024-12-26 06:04:31', 1),
	(13, '2024', '00000009', 1, NULL, 1, '<p>ESTO ES GENIAL</p>', 2, '2024-12-25 21:35:00', '2024-12-26 07:35:28', '2024-12-26 07:35:28', 1),
	(14, '2024', '00000010', 1, NULL, 4, '<p>ella es abad</p>', 2, '2024-12-26 21:35:00', '2024-12-26 07:35:49', '2024-12-26 07:35:49', 2),
	(15, '2024', '00000011', 1, NULL, 1, '<p>el estudiante se peleo</p>', 2, '2024-12-26 12:35:00', '2024-12-26 18:37:18', '2024-12-26 18:37:18', 2),
	(16, '2024', '00000011', 1, NULL, 4, '<p>el estudiante se peleo</p>', 2, '2024-12-26 12:35:00', '2024-12-26 18:37:18', '2024-12-26 18:37:18', 2),
	(17, '2024', '00000012', 7, NULL, 1, '<p>este alumno se peleo con todos y todas</p>', 2, '2024-12-28 00:12:00', '2024-12-29 06:13:34', '2024-12-29 06:13:34', 1),
	(18, '2024', '00000013', 7, NULL, 1, '<p>ESTO ES GENIALA</p>', 2, '2024-12-26 20:14:00', '2024-12-29 06:14:49', '2024-12-29 06:14:49', 1),
	(19, '2024', '00000014', 1, NULL, 1, '<p>esto es la pelea</p>', 2, '2024-12-25 23:15:00', '2024-12-29 06:15:35', '2024-12-29 06:15:35', 2),
	(20, '2024', '00000015', 1, NULL, 1, '<p>esto es genial, el codigo</p>', 2, '2024-12-11 20:16:00', '2024-12-29 06:16:53', '2024-12-29 06:16:53', 1),
	(21, '2024', '00000016', 1, NULL, 1, '<p>esto es genial, el codigo</p>', 2, '2024-12-11 20:16:00', '2024-12-29 06:16:59', '2024-12-29 06:16:59', 1),
	(22, '2024', '00000017', 1, NULL, 1, '<p>esto es genial</p>', 2, '2024-12-25 20:17:00', '2024-12-29 06:17:39', '2024-12-29 06:17:39', 1),
	(23, '2024', '00000018', 1, NULL, 1, '<p>esto es una busqeda de alumno</p>', 2, '2024-12-23 20:24:00', '2024-12-29 06:24:54', '2024-12-29 06:24:54', 1),
	(24, '2024', '00000019', 1, NULL, 1, '<p>esto es la problema</p>', 2, '2024-12-28 20:25:00', '2024-12-29 06:25:31', '2024-12-29 06:25:31', 2),
	(25, '2024', '00000020', 1, NULL, 1, '<p>esto es genial</p>', 2, '2025-01-02 20:26:00', '2024-12-29 06:26:54', '2024-12-29 06:26:54', 1),
	(26, '2024', '00000021', 1, NULL, 1, '<p>esto es la guerra hermano</p>', 2, '2024-12-25 20:27:00', '2024-12-29 06:27:46', '2024-12-29 06:27:46', 2),
	(27, '2024', '00000022', 1, NULL, 1, '<p>Este es sergio</p>', 2, '2025-01-02 20:28:00', '2024-12-29 06:28:42', '2024-12-29 06:28:42', 1);
...
INSERT INTO `incidencia_monitoreo` (`id`, `fecha_hora`, `id_estado_monitoreo`, `problema`, `acuerdos`, `id_incidencia`, `descripcion_privada`, `id_usuario`, `id_empresa`) VALUES
	...
	(9, '2024-12-30 19:40:00', 4, '<p>esto es testing</p>', '<p>esto es testing</p>', 27, '<p>esto es testing</p>', 2, 1),
	(10, '2024-12-21 21:18:00', 4, '<p>estoy probando</p>', '<p>estoy probando</p>', 27, '<p>estoy probando</p>', 2, 1),
	(11, '2025-01-03 18:25:00', 5, '<p>esto es un proceso</p>', '<p>esto es un proceso</p>', 27, '<p>esto es un proceso</p>', 2, 1),
	(12, '2024-12-31 22:52:00', 4, '<p>Voy preparando mis respuestzas</p>', '<p>Voy preparando mis respuestzas</p>', 26, '<p>se propone tener mejor c omportamiento</p>', 2, 1);
...
INSERT INTO `lugar` (`id`, `nombre`, `id_empresa`, `referencia`, `estado`) VALUES
	(1, 'PATIO ACADEMICO', 1, 'EN EL CENTRO', NULL),
	(2, 'COMEDOR', 1, 'AA', NULL),
	(3, 'CANCHA DEPORTIVA', 1, 'SS', NULL);
...
-- Volcando datos para la tabla coar.permiso: ~5 rows (aproximadamente)
INSERT INTO `permiso` (`id`, `view`, `new`, `edit`, `delete`, `id_rol`, `menu`) VALUES
	(0, 1, 1, 0, 0, 1, 'configuracion-empresa'),
	(0, 1, 0, 0, 0, 1, 'configuracion-area'),
	(0, 1, 1, 0, 0, 1, 'configuracion-tipos_incidencia'),
	(0, 0, 1, 0, 0, 1, 'configuracion-tipo_personal'),
	(0, 0, 1, 0, 0, 1, 'configuracion-rol');
...
-- Volcando datos para la tabla coar.personal: ~1 rows (aproximadamente)
INSERT INTO `personal` (`id`, `numero_documento`, `id_tipo_personal`, `imagen`, `firma`, `codigo`, `nombre`, `apellido`, `telefono`, `estado`, `id_tipo_documento`, `tipo_contratacion`, `direccion`, `ubigeo`, `comentario`, `Columna 16`, `id_proveedor`) VALUES
	(1, 12344845, 1, 'sin_imagen.jpg', 'sin_imagen.jpg', NULL, 'SERGIO', 'SSSS', NULL, 1, 2, 'DIRECTA', 'KM 14  CARRETRA CENTRAL', '010605', 'dasdasd', NULL, NULL);
...
INSERT INTO `tipos_incidencias` (`id`, `nombre`, `necesita_abordaje_directa`, `estado`, `es_conducta_positiva`, `es_anedotario`, `cantidad_abordaje`, `nivel_incidencia`, `id_usuario`, `id_empresa`) VALUES
	(1, 'PELEA DE ALUMNOSs', _binary 0x30, 1, 0, 0, 0, 'INTERMEDIO', 2, 1),
	(7, 'PERSONA', _binary 0x30, 1, 0, 0, 0, 'LEVE', 2, 1);
...
-- Volcando datos para la tabla coar.usuario: ~5 rows (aproximadamente)
INSERT INTO `usuario` (`id`, `imagen`, `nombre`, `apellido`, `usuario`, `email`, `password`, `salt`, `color`, `id_membresia`, `tipo`, `id_personal`, `id_rol`, `login_date`, `token`, `id_empresa`, `id_local`, `id_area`, `fl_suspendido`, `tipo_persona`, `id_cliente`, `fl_cambio_local`, `fl_supervisor`, `fl_clave`, `fl_orden_servicio`, `estado`, `id_estudiante`) VALUES
	(1, 'sin_imagen.jpg', 'SUPER', 'SUPER', '@dmin', NULL, '3b2013f022c6ff6210b64c6bcd8c7a0ee5e4ecad245f97c8a56d1f34422a2b84758eda5c60219445e887155b1f2fc2b80fd138169ae3df9b772f5a78affb2b71', 'be2b184f26a724f95145c51df6eb93f464aed0bb307f306108d2489fd812a90acb0089e85ec6c348c0ecdee3aff73b898d27df6b2cb57026bd848be29054d9e8', NULL, NULL, 'SUPER USUARIO', NULL, NULL, '2024-12-09 11:48:27', '', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
	(2, 'sin_imagen.jpg', 'soporte', 'soporte', 'soporte', 'soporte@gmail.com', '5bd10d095a11e546a6f2d9b16125c61b0c2babb9802fed8353932cfadfe4e21a81c99c1df307e59ed340359b82b9b0bca4c6e8ea163c08997575b28f433fcebc', 'b9c0126c7ccdbfe7754a4c5f6909022fd6d47acb630655ab67039cef3c5b94ef8501e3231c9cc7154c1593f4a1e81492a5aaa1cb469c22a3b09b6a85d0aa85ad', NULL, 1, 'SUPER ADMINISTRADOR', NULL, NULL, '2024-12-31 08:56:50', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1bmlxdWVJZCI6IjIiLCJyb2xlIjoiU1VQRVIgQURNSU5JU1RSQURPUiIsInRpbWVTdGFtcCI6IjIwMjQtMTItMzEgMDg6NTY6NTAifQ.aoIa3h1lX3BAOoFCK8u_YEfNEeVvOCuLeiSvXQApnpo', 1, NULL, 0, NULL, NULL, NULL, 1, NULL, NULL, NULL, 0, NULL),
