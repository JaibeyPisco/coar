...
<div id="main">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Estado monitoreo</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            <div class="btn-group">
                <button type="button" class="btn btn-success px-4 btn-success-dark btn-sm" name="nuevo"><i class="lni lni-circle-plus" style="font-size:15px;"></i>Nuevo</button>
            </div>
        </div>
    </div>
    <!--end breadcrumb-->
    ...
    <modal-delete-estado-monitoreo></modal-delete-estado-monitoreo>
</div>           
