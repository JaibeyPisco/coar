...
let Componente = {
    ...
    datatable: function() {
        ...
        this.table = DOM.find('table[name="registros"]').DataTable({
            ajax:   {
                url: BASE_API + 'almacen/tipo_articulo',
            },
            columns: [{
                    title: 'ACCIÓN',
                    defaultContent: ``,                    
    ...
    new: function() {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Nuevo Tipo de Artículo');
    ...
    edit: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Editar Tipo de Artículo');
    ...
    delete: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Eliminar Tipo de Artículo');
    ...
    submit: function() {
        ...
        axios({
            method: 'post',
            url: BASE_API + 'almacen/tipo_articulo/' + this.action_submit,
            data: formData
        })
