...
let Componente = {
                                ...
                                <div class="row">                                   
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Nombre (Ubicación)<span class="text-red">(*)</span></label>
    ...
    new: function() {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Nuevo Almacen');
    ...
    edit: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Editar Almacen');
    ...
    delete: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Eliminar Almacen');
    ...
    submit: function() {
        ...
        axios({
            method: 'post',
            url: BASE_API + 'almacen/almacen/' + this.action_submit,
            data: formData
        })
