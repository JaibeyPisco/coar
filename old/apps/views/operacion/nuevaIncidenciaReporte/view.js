export default async function(datos_estudiante, datasa, datos_incidencia_atencion, datos_incidencia_abordaje){

    let data = {
        "fechaDesde": datasa.fecha,
    ...
    detalleHTML = HELPER.template(detail(), {
        fecha_incidencia: datasa.fecha,
        serie_numero: datasa.serie + "-" + datasa.numero,
        nombre_incidencia: datasa.nombre_incidencia,
        estado_incidencia: estado_incidencia,
        se_soluciono: datasa.se_soluciono == 1 ? "Si" : "No",
        descripcion_incidencia: datasa.describir_incidencia,
        esta_comentario_atencion_incidencia: datos_incidencia_atencion.comentario_atencion_incidencia ? "block" : "none", 
        comentario_atencion_incidencia: datos_incidencia_atencion.comentario_atencion_incidencia,
        esta_acuerdo_atencion_abordaje : datos_incidencia_abordaje.acuerdos ? "block" : "none",
        acuerdo_atencion_abordaje: datos_incidencia_abordaje.acuerdos,
        descripcion_privada_atencion_abordaje: datos_incidencia_abordaje.descripcion_privada
    });     
