...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>Arrastre y suelte el archivos excel aquí para importar</span><button type="button"class="btn btn-default">o seleccione el archivo para cargar</button></div></div>`);
			...
			const readingFile = (id, file) => {
				...
				if (file.type && file.type.search(/image/) != -1) {
					...
					} else if (file.type.search(/excel|xls/) != -1) {
