...
export default function({
    text = 'Procesando...',
    element = document.querySelector('loader-submit'),
    size = '64',
    color = '#3b71ca',
    bg = '#fff',
    opacity = 0.5
   ...
   setTimeout(() => {
    element.querySelector('div[data-loader-frame="loader"]').removeAttribute('class');
   }, 400);*/
    
    const stopLoader = async (sleep = this.sleep) => {
