...
let Componente = {
    ...
    datatable: function() {
        ...
        this.table = DOM.find('table[name="registros"]').DataTable({
            ajax:   {
                url: BASE_API + 'almacen/unidad_medida',
            },
            columns: [{
                    title: 'ACCIÓN',
                    defaultContent: ``,                    
                ...
                { title: 'CÓDIGO SUNAT', mData: 'codigo_sunat' },
            ],
        });
    ...
    new: function() {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Nueva Unidad de Medida');
    ...
    edit: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Editar Unidad de Medida');
    ...
    delete: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Eliminar Unidad de Medida');
    ...
    submit: function() {
        ...
        axios({
            method: 'post',
            url: BASE_API + 'almacen/unidad_medida/' + this.action_submit,
            data: formData
        })
        .then(function(response) { 
