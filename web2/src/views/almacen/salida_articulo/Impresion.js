 ...
 */
 ...
 let Componente = {
     ...
     print: async (id) => {
         ...
         await axios.get(BASE_API + 'almacen/salida_articulo/imprimir/'+id)
                    ...
                    <tr>
                        ...
                        <td style="width:35%;">
                            <div style="text-align:center; background-color:#eeeeee !important; border: 1px solid #bebdbd !important; border-radius:8px; padding:8px;">
                                ...
                                <div style="font-weight:bold; font-size:18px;">SALIDA DE ALMACÉN</div>
                            ...
                            <div style="background-color:#fff !important; border: 1px solid #bebdbd !important; border-radius:8px; margin-top:10px; padding:5px; min-height:80px;">
                                <table style="width:100%;">
                                   <tr>
                                    ...
                                    <tr>
                                        <td style="vertical-align:top;"><strong>VEHÍCULO</strong></td>
                                        <td style="vertical-align:top;">: `+data.vehiculo+`</td>
                                    </tr>
                                    <tr>
