...
let Componente = {
    ...
    new: function() {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Nueva Marca');
    ...
    edit: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Editar Marca');
    ...
    delete: function(row) {
        ...
        DOM.find('h4[name="'+accion+'"]').text('Eliminar Marca');
    ...
    submit: function() {
        ...
        axios({
            method: 'post',
            url: BASE_API + 'almacen/marca/' + this.action_submit,
            data: formData
        })
