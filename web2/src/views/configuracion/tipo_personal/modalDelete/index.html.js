export default /*html*/`
       <!-- MODAL DELETE -->
       <div class="modal inmodal fade" name="modal-tipo-personal-delete" data-backdrop="static" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 name="modal-tipo-personal-delete" class="modal-title">Eliminar Tipo Personal</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form name="tipo-personal-delete">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" align="center">
                                        <label><input type="checkbox" name="confirmacion" required />
                                            Confirmo realizar la eliminación del Tipo Personal</label>
