...
let Componente = {
                            ...
                            <div class="row">
                                ...
                                <div class="box box-widget widget-user-2">
                                    <div class="widget-user-header bg-blue">
                                        ...
                                        <h3 class="widget-user-username" style=" margin-left:50px;">Términos y Condiciones</h3>
                                    </div>
                                    <div class="box-footer no-padding">
                                        <ul class="nav nav-stacked">
                                            <li><a href="javascript:"><strong>Orden de Servicios</strong></a></li>
                                            <li><textarea class="form-control" name="termino_condicion_orden" style="height:250px;"></textarea></li> 
                                        </ul>
                                    </div>
                                </div>
                                <!-- /.widget-user -->
    ...
    get: async function() {
        ...
        .then(function(response) {
            ...
            form.find('textarea[name="termino_condicion_orden"]').val(data.termino_condicion_orden);
